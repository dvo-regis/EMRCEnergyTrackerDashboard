    ...
    var getDefaultOptions = function getDefaultOptions() {
      return {
        ...
        yAxis: {
          ...
          data: ['KAINJI', 'JEBBA', 'SHIRORO', 'EGBIN', 'SAPELE', 'DELTA', 'AFAM IV-V',
                 'GEREGU GAS', 'OMOTOSHO GAS', 'OLORUNSOGO GAS', 'GEREGU NIPP', 'SAPELE NIPP', 
                 'ALAOJI NIPP', 'OLORUNSOGO NIPP', 'OMOTOSHO NIPP', 'IHOVBOR NIPP', 'OKPAI', 'AFAM VI', 
                 'IBOM POWER', 'OMOKU', 'A.E.S', 'TRANS AMADI', 'RIVERS IPP', 'ASCO', 'ODUKPANI', 'GBARAIN NIPP',
                 'EGBEMA NIPP', 'OMOKU NIPP',
                ]
        },
        series: [{
