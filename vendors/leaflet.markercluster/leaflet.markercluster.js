!function(e, t) {
    ...
    var t = L.MarkerClusterGroup = L.FeatureGroup.extend({
            ...
            if (this._map) {
                var f = (new Date).getTime()
                  , m = L.bind(function() {
                    ...
                    p === d ? (this._topClusterLevel._recalculateBounds(),
                    this._refreshClustersIcons(),
                ...
                for (var e = this._needsClustering; p < d; p++)
                    (o = n[p])instanceof L.LayerGroup ? (c && (n = n.slice(),
                    c = !1),
                    this._extractNonGroupLayers(o, n),
                    d = n.length) : o.getLatLng ? this.hasLayer(o) || e.push(o) : h.addLayer(o);
            return this
        },
        removeLayers: function(e) {
            ...
            if (!this._map) {
                for (t = 0; t < r; t++)
                    (i = e[t])instanceof L.LayerGroup ? (o && (e = e.slice(),
                    o = !1),
                    this._extractNonGroupLayers(i, e),
                    r = e.length) : (this._arraySplice(this._needsClustering, i),
                    s.removeLayer(i),
            ...
            if (this._unspiderfy) {
                ...
                var a = e.slice()
                  , h = r;
                for (t = 0; t < h; t++)
                    (i = a[t])instanceof L.LayerGroup ? (this._extractNonGroupLayers(i, a),
            ...
            for (t = 0; t < r; t++)
                ...
                o = !1),
                this._extractNonGroupLayers(i, e),
                r = e.length) : i.__parent ? (this._removeLayer(i, !0, !0),
                this.fire("layerremove", {
                    layer: i
                }),
        ...
        _addLayer: function(e, t) {
            ...
            e.on(this._childMarkerEventHandlers, this); o <= t; t--) {
                ...
                if (n = this._grid[t])
                    for (i = l - 1; i <= l + 1; i++)
                        if (s = n[i])
                            ...
                            o = s.length; r < o; r++)
                                a = s[r],
                                ((h = this._sqDist(_[L.Util.stamp(a)], e)) < d || h <= d && null === p) && (d = h,
                                p = a);
            return p
        },
    ...
    L.QuickHull = {
        ...
        findMostDistantPointFromBaseLine: function(e, t) {
            ...
            for (i = t.length - 1; 0 <= i; i--)
                r = t[i],
                0 < (n = this.getDistant(r, e)) && (a.push(r),
                s < n && (s = n,
                o = r));
            return {
                maxPoint: o,
    ...
    L.MarkerCluster.include({
        ...
        spiderfy: function() {
            if (this._group._spiderfied !== this && !this._group._inZoomAnimation) {
                ...
                e = (this._group._spiderfied = this)._group.options.spiderfyShapePositions ? this._group.options.spiderfyShapePositions(t.length, i) : t.length >= this._circleSpiralSwitchover ? this._generatePointsSpiral(t.length, i) : (i.y += 10,
                this._generatePointsCircle(t.length, i)),
    ...
    L.MarkerCluster.include({
        ...
        _animationUnspiderfy: function(e) {
            ...
            this.setOpacity(1),
            i = d.length - 1; 0 <= i; i--)
                (t = d[i])._preSpiderfyLatlng && (t.closePopup(),
                ...
                o = !1),
                o && u.removeLayer(t),
                p && (s = (n = (r = t._spiderLeg)._path).getTotalLength() + .1,
            ...
            setTimeout(function() {
                ...
                for (i = d.length - 1; 0 <= i; i--)
                    (t = d[i])._spiderLeg && e++;
                for (i = d.length - 1; 0 <= i; i--)
                    (t = d[i])._spiderLeg && (t.clusterShow && t.clusterShow(),
